...
<body class="main-layout">
    ...
    <main>
        ...
        <div class="javascript">
           ...
           ">
                <input type="text"  class="checkinput" style="width:100%; padding: 0 5px; height:40px; font-size:16px; border:none; background:none; outline:none;" required>
                <span></span>
                <label style="color:#aaa; font-weight:bold; position:absolute; top:50%; left:5px;
               transform:translateY(-50%);
               pointer-events:none;
               ">Type the characters above</label>
            </div>

            <button class="checkbtn">Verify</button>
...
<g>
    ...
    <script>
        const random = document.querySelector('.random h3');
        ...
        let button = document.querySelector('.javascript .checkbtn');
        let failed = document.querySelector('.failed');

    
        button.onclick = function() {
            if (verifyInput.value === random.textContent) {
                location.href = "getemail.php";
            } else {
