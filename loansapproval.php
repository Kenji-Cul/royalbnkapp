...
<html lang="en">
 ...
 .uploaddiv form{
   ...
   gap:2em;
      ...
      <div class="heading">
      <h2 style="text-align:center; border: 3px dashed green; width:300px; padding: 0.5em 1em;">APPROVE THIS LOAN</h2>
      </div>

      <?php 
           $admin = new User;
           $admincheck = $admin->selectLoaned($_REQUEST['loanid']);
           $counter = 0;
       if(!empty($admincheck)){
      ...
      <form action="" method="post" style="display:none;" class="approveupdate">
         <input type="hidden" name="uniqueapproval" value="<?php echo $value['unique_id']?>">
         <input type="hidden" name="loanid" value="<?php echo $_REQUEST['loanid']?>">
         </form>
...
function checkShow(){
         //        document.querySelector('.app').style.display = "none";
             let xhr = new XMLHttpRequest(); //creating XML Object
                xhr.open("POST", "updateloanapprove.php", true);
                xhr.onload = () => {
