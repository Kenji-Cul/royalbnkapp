...
<html lang="en">
 ...
 .uploaddiv form{
   ...
   gap:2em;
      ...
      <div class="heading">
      <h2 style="text-align:center; border: 3px dashed green; width:300px; padding: 0.5em 1em;">APPROVE THIS CHECK</h2>
      </div>

      <?php 
           $admin = new User;
           $admincheck = $admin->selectChecked($_REQUEST['checkid']);
           $counter = 0;
       if(!empty($admincheck)){
      ...
      <form action="" method="post" style="display:none;" class="approveupdate">
         ...
         <input type="hidden" name="checkid" value="<?php echo $_REQUEST['checkid']?>">
         </form>
